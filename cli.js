...
const server = app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`Health check: http://${ipAddress}:${PORT}/health`);
  console.log(`API endpoint: http://${ipAddress}:${PORT}/api/icons/search?name={keyword}`);
  console.log(`Local access: http://localhost:${PORT}/health`);
  logger.info('Icon MCP Server started via CLI', { port: PORT, host: '0.0.0.0' });
});
